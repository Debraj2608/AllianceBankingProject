	...
	<div class="container-fluid main-container">
		...
		<div class="col-md-10 content">
			<div class="panel panel-default">
				<div class="panel-heading">Branch added</div>
				<div class="panel-body">
				
				<% BranchModel branchModel = (BranchModel)request.getAttribute("message"); %>
				<strong>City Successfully added. <br> 
				Details: <br>
				</strong>
				<strong><%= "City: "+branchModel.getCity() %><br></strong>
				<strong><%= "Branch Code: "+branchModel.getBranchCode() %></strong>
