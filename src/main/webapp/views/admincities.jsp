  ...
  <p class="output">Please try again </p>
	...
	<div class="container-fluid main-container">
		...
		<div class="col-md-10 content">
			...
			<li><a href="UpdateCitiesController"><span
			class="glyphicon glyphicon-pencil"></span> Update Cities and Branch Codes </a></li><br>
			<li><a href="ViewCitiesController"><span
			class="glyphicon glyphicon-pencil"></span> View Cities and branch codes </a></li>
